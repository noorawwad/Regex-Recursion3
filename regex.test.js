...
function capitalA(s){
    let checkLatter =/[A-Z][a-z]/
    let checkEndLatter=/A$/
    let result1 =checkEndLatter.test(s);
    let result2 = checkLatter.test(s);
...
function ioEmail(email){
    let regex= /\w @\w[.]/
    let regex1=/io$/
    let result1 =regex.test(email);
    let result2 =regex1.test(email);
    if(result1==true && result2==true){
      return true;
    } else {return false;}
